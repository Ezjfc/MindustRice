// Decompiled from Mindustry.jar v8 Build 158.1 2026-06-27
...
public class Icon {
    ...
    public static TextureRegionDrawable arrowNoteSmall;
    public static TextureRegionDrawable arrowNote;
    ...
    public static void load() {
        ...
        planetSmall = Fonts.getGlyph(Fonts.def, '\ue833');
        planet = Fonts.getGlyph(Fonts.icon, '\ue833');
        icons.put("planet", planet);
        icons.put("planetSmall", planetSmall);
        arrowNoteSmall = Fonts.getGlyph(Fonts.def, '\ue834');
        arrowNote = Fonts.getGlyph(Fonts.icon, '\ue834');
        icons.put("arrowNote", arrowNote);
        icons.put("arrowNoteSmall", arrowNoteSmall);
    }
}
